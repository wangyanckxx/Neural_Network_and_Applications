...
I4=rgb2gray(I4);
[h,w] = size(I1);
% I1 = imread('1.bmp');I2 = imread('2.bmp');I3 = imread('3.bmp');I4 = imread('4.bmp');
[h,w] = size(I1);
s1=reshape(I1,[1,h*w]);
s2=reshape(I2,[1,h*w]);
s3=reshape(I3,[1,h*w]);
